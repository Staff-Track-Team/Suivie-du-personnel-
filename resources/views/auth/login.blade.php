...
<head>
    ...
    <title>Connexion - CFP-CMD Gestion RH</title>
    ...
    <div class="w-full max-w-md bg-white/70 backdrop-blur-2xl rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/40 relative z-10 transition-all duration-500 hover:shadow-blue-500/20">
        <div class="p-8 md:p-10">
            <div class="text-center mb-8">
                ...
                <p class="text-slate-500 mt-2 text-sm leading-relaxed">Système de Gestion des Ressources Humaines de CFP-CMD.<br>Connectez-vous pour accéder à votre espace RH.</p>
            </div>
            ...
            <form action="{{ route('auth.login') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    <label for="email" class="text-sm font-medium text-slate-700">Email RH</label>
                    <div class="relative">
                        ...
                        placeholder="nom@cfp-cmd.cm" value="{{ old('email') }}" required autofocus>
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('password.request') }}" class="text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors">Mot de passe oublié ?</a>
                    </div>
                    <div class="relative">
        ...
        <div class="px-8 py-6 bg-slate-50 border-t border-slate-100 text-center">
            <p class="text-xs text-slate-400">© 2026 CFP-CMD. Système RH - Tous droits réservés.</p>
        </div>
    </div>
