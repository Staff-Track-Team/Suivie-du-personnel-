...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center gap-3">
                ...
                <h1 class="text-2xl font-bold text-slate-800">Nouvel administrateur</h1>
            </div>
            <p class="text-slate-500 ml-10">Création d'un nouveau compte avec privilèges d'administration.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.admins.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        @csrf
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.admins.index') }}" class="px-6 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold hover:bg-slate-50 transition-colors">
                    Annuler
                </a>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100 hover:shadow-md transition-all duration-300">
                ...
                <ul class="space-y-3 text-sm text-blue-700">
                    ...
                    <li class="flex items-start gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        <span>Le mot de passe doit être fort pour garantir la sécurité.</span>
                    </li>
                    <li class="flex items-start gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        <span>La photo de profil est recommandée.</span>
                    </li>
                </ul>
            </div>

            <!-- Permissions -->
            <div class="bg-green-50 rounded-2xl p-6 border border-green-100 hover:shadow-md transition-all duration-300">
                 <h3 class="font-bold text-green-800 flex items-center gap-2 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                    Permissions
                </h3>
                <p class="text-sm text-green-700 mb-3">Ce compte aura un accès complet :</p>
                <div class="flex flex-wrap gap-2">
                    <span class="px-2 py-1 bg-white text-green-700 rounded text-xs border border-green-200 font-semibold">Gestion Utilisateurs</span>
                    <span class="px-2 py-1 bg-white text-green-700 rounded text-xs border border-green-200 font-semibold">Gestion Projets</span>
                    <span class="px-2 py-1 bg-white text-green-700 rounded text-xs border border-green-200 font-semibold">Configuration</span>
                </div>
            </div>
        </div>
    </form>
